...
<p align="center">
  <a href="LICENSE"><img src="https://img.shields.io/github/license/jastfan/adhd?style=flat" alt="License"></a>
</p>
...
10 rules. Full text in [SKILL.md](./skills/adhd-mode/SKILL.md).
...
Fork, edit `skills/adhd-mode/SKILL.md`, then swap your copy in:
...
Restart Claude Code, then re-invoke `/adhd-mode`.
