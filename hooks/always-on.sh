#!/usr/bin/env sh
# SessionStart hook: injects the full adhd-mode ruleset when the user has
# opted in by creating $CLAUDE_CONFIG_DIR/.adhd-mode-always (default ~/.claude).
...
flag_path="$claude_dir/.adhd-mode-always"
...
skill_path="$script_dir/../skills/adhd-mode/SKILL.md"
[ -f "$skill_path" ] || exit 0
