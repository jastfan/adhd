...
# adhd-mode ruleset when the user has opted in by creating
# $CLAUDE_CONFIG_DIR/.adhd-mode-always (default ~/.claude).
...
try {
  ...
  $flagPath = Join-Path $claudeDir ".adhd-mode-always"
  ...
  $skillPath = Join-Path $scriptDir "../skills/adhd-mode/SKILL.md"
