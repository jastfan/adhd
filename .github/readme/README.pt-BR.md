...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/jastfan/adhd?style=flat" alt="Licença"></a>
</p>
...
10 regras. Texto completo no [SKILL.md](../../skills/adhd-mode/SKILL.md).
...
Faça um fork, edite `skills/adhd-mode/SKILL.md` e troque pela sua cópia:

```bash
claude plugin uninstall adhd-mode            # remova a cópia do upstream primeiro:
claude plugin marketplace remove adhd-mode   # fork e upstream compartilham o mesmo nome
claude plugin marketplace add <seu-usuario>/adhd-mode
claude plugin install adhd-mode@adhd-mode
```

Reinicie o Claude Code e invoque `/adhd-mode` de novo.
