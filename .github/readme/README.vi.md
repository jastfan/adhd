<p align="center">
  <img src="../../logo.png" alt="adhd-mode" width="140" />
</p>
<p align="center">
  <strong align="center">Đầu ra thân thiện với người có ADHD. Không cần chẩn đoán ADHD!</strong>
</p>
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/jastfan/adhd?style=flat" alt="Giấy phép"></a>
</p>
...
10 quy tắc. Nội dung chi tiết tại [SKILL.md](../../skills/adhd-mode/SKILL.md).
...
Fork repo, chỉnh sửa `skills/adhd-mode/SKILL.md`, sau đó chuyển sang dùng bản của bạn:

```bash
claude plugin uninstall adhd-mode            # gỡ bản chính trước:
claude plugin marketplace remove adhd-mode   # bản fork và bản chính dùng chung tên
claude plugin marketplace add <username-của-bạn>/adhd-mode
claude plugin install adhd-mode@adhd-mode
```

Khởi động lại Claude Code, sau đó gọi lại `/adhd-mode`.
