...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/jastfan/adhd?style=flat" alt="许可证"></a>
</p>
...
共 10 条规则。完整内容见 [SKILL.md](../../skills/adhd-mode/SKILL.md)。
...
Fork 此仓库，编辑 `skills/adhd-mode/SKILL.md`，然后换成你的副本：
...
重启 Claude Code，然后再次调用 `/adhd-mode`。
