...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/jastfan/adhd?style=flat" alt="ライセンス"></a>
</p>
...
```text
Install the adhd-mode skill/plugin from https://github.com/jastfan/adhd, refer to the repo's AGENTS.md for instructions.
```
...
ルールは10個。全文は [SKILL.md](../../skills/adhd-mode/SKILL.md) を参照してください。
...
リポジトリをForkし、`skills/adhd-mode/SKILL.md` を編集してから自分のコピーに差し替えます。
...
Claude Code を再起動し、`/adhd-mode` をもう一度呼び出してください。
