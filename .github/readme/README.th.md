...
<p align="center">
  <a href="../../LICENSE"><img src="https://img.shields.io/github/license/jastfan/adhd?style=flat" alt="สัญญาอนุญาต"></a>
</p>
...
มีทั้งหมด 10 ข้อ อ่านฉบับเต็มได้ใน [SKILL.md](../../skills/adhd-mode/SKILL.md)
...
Fork โปรเจกต์นี้ และแก้ไขไฟล์ `skills/adhd-mode/SKILL.md` จากนั้นเปลี่ยนไปใช้เวอร์ชันของคุณด้วยคำสั่งต่อไปนี้:
...
รีสตาร์ต Claude Code จากนั้นเรียกใช้ `/adhd-mode` อีกครั้ง
